...
Blockly.Msg.FOR = "for";
Blockly.Msg.GET = "hae";
Blockly.Msg.GETSAMPLE_TOOLTIP = "Hakee määritetyn sensorin tämän hetkisen lukeman.";
...
Blockly.Msg.LOOPFOREVER_TOOLTIP = "Toistaa toimintoa ikuisesti.";
...
Blockly.Msg.MENU_GENERAL = "yleinen ohje (en)";
...
Blockly.Msg.MENU_PROGRAMMING = "NEPO-ohjelmointi (en)";
...
Blockly.Msg.MENU_ROBOT_STATE_TOOLTIP = "tietoja robotista";
Blockly.Msg.MENU_ROBOT_TOOLTIP = "robotit";
Blockly.Msg.MENU_SAVE = "tallenna";
Blockly.Msg.MENU_SAVE_AS = "tallenna nimellä ...";
Blockly.Msg.MENU_SHOW_AGAIN = "näytä tervetuloviesti";
Blockly.Msg.MENU_SHOW_CODE = "näytä ohjelmakoodi";
Blockly.Msg.MENU_SIM_BACK = "Takaisin muokkaukseen";
...
Blockly.Msg.MENU_SIM_INFO = "Tietoja";
...
Blockly.Msg.MENU_SIM_START_PAUSE = "Käynnistä/tauko";
Blockly.Msg.MENU_SIM_START_TOOLTIP = "Start your program in the simulation.";  // untranslated
Blockly.Msg.MENU_SIM_STEP = "Tee vaiheittain";
Blockly.Msg.MENU_SIM_STOP = "Pysäytä";
...
Blockly.Msg.MENU_USER_STATE_TOOLTIP = "käyttäjän tiedot";
...
Blockly.Msg.MOTORDIFF_ON_FOR_TOOLTIP = "Käynnistää robotin määritetyllä nopeudella ja pysäyttää sen määritetyn matkan jälkeen.";
Blockly.Msg.MOTORDIFF_ON_TOOLTIP = "Käynnistää robotin määritetyllä nopeudella.";
Blockly.Msg.MOTORDIFF_STOP_TOOLTIP = "Pysäyttää robotin.";
Blockly.Msg.MOTORDIFF_TURN_FOR_TOOLTIP = "Kääntää robottia määritetyn astemäärän verran.";
Blockly.Msg.MOTORDIFF_TURN_TOOLTIP = "Kääntää robottia";
...
Blockly.Msg.TOUCH_ISPRESSED_TOOLTIP = "Tunnistaa onko kosketussensoria määritetyssä portissa painettu.";
...
Blockly.Msg.ULTRASONIC_GETSAMPLE_TOOLTIP = "Hakee ultraäänisensorin tämän hetkisen lukeman.";
