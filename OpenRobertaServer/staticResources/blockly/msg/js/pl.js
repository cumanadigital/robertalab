...
Blockly.Msg.BUTTON_DO_DELETE = "Usuń";
Blockly.Msg.BUTTON_DO_SHARE = "Udostępnij";
Blockly.Msg.BUTTON_EMPTY_LIST = "Pusta lista";
Blockly.Msg.BUTTON_FINISH = "Koniec";
Blockly.Msg.BUTTON_LOAD = "ładuj";
Blockly.Msg.BUTTON_MORE = "więcej";
Blockly.Msg.BUTTON_REFRESH = "Odśwież";
Blockly.Msg.BUTTON_START = "Wypróbuj";
...
Blockly.Msg.CONNECTION_USED_CONNECTION = "za pośrednictwem połączenia";
...
Blockly.Msg.DATATABLE_BLOCKS = "Klocki";
...
Blockly.Msg.DATATABLE_SHOW = "Pokaż";
...
Blockly.Msg.IFELSE_TOOLTIP = "Sprawdza warunek w 'if'. Jeśli warunek jest spełniony, wykonuje akcję 'do'; inaczej wykonuje akcję 'else'";
...
Blockly.Msg.KEY_ISPRESSEDANDRELEASED_TOOLTIP = "Czy wybrany przycisk został wciśnięty i zwolniony?";
...
Blockly.Msg.MENU_BUILDING_INSTRUCTIONS = "instrukcje budowania";
...
Blockly.Msg.MENU_SIM_BACK_TOOLTIP = "powrót do edytora programowania";
...
Blockly.Msg.MENU_SIM_START_PAUSE = "Start/Pauza";
...
Blockly.Msg.MENU_UPDATE_FIRMWARE = "aktualizacja firmware";
...
Blockly.Msg.MESSAGE_PASSWORD_ERROR = "Hasła nie pasują do siebie.";
Blockly.Msg.MESSAGE_PROGRAM_DELETED = "Program '$' został usunięty";
Blockly.Msg.MESSAGE_RELATION_DELETED = "Relacja z programu '$' została usunięta";
...
Blockly.Msg.MESSAGE_ROBOT_FIRMWARE_UPDATE = "Twój Robot działa teraz w wersji '$'";
...
Blockly.Msg.MESSAGE_USER_NEW = "Witaj '$'";
...
Blockly.Msg.ORA_PROGRAM_SAVE_ERROR_NOT_SAVED_TO_DB = "Wystąpił błąd podczas zapisywania programu.";
...
Blockly.Msg.ORA_TOOLBOX_LOAD_ERROR_NOT_FOUND = "Wybranych Klocków NEPO nie można znaleźć w bazie danych.";
Blockly.Msg.ORA_TOOLBOX_LOAD_SUCCESS = "Przybornik został załadowany";
