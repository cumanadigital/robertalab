...
Blockly.Msg.BUTTON_DO_DELETE = "Apagar";
Blockly.Msg.BUTTON_DO_SHARE = "Partilhar";
Blockly.Msg.BUTTON_EMPTY_LIST = "Esvaziar lista";
Blockly.Msg.BUTTON_FINISH = "Terminar";
Blockly.Msg.BUTTON_LOAD = "Carregar";
Blockly.Msg.BUTTON_MORE = "Mais";
Blockly.Msg.BUTTON_REFRESH = "Atualizar";
Blockly.Msg.BUTTON_START = "Testar";
...
Blockly.Msg.CONNECTION_USED_CONNECTION = "via conexão";
...
Blockly.Msg.DATATABLE_BLOCKS = "Blocos";
...
Blockly.Msg.IFELSE_TOOLTIP = "senão executa a acção 'else'";
...
Blockly.Msg.KEY_ISPRESSEDANDRELEASED_TOOLTIP = "Estás a pressionar e a soltar o botão seleccionado?";
...
Blockly.Msg.MENU_BUILDING_INSTRUCTIONS = "instrucões de construção";
...
Blockly.Msg.MENU_SIM_BACK_TOOLTIP = "Voltar ao editor do programa";
...
Blockly.Msg.MENU_SIM_INFO = "Informação";
...
Blockly.Msg.MENU_SIM_START_PAUSE = "Iniciar/Pausar";
...
Blockly.Msg.MENU_UPDATE_FIRMWARE = "atualizar firmware";
...
Blockly.Msg.MESSAGE_PASSWORD_ERROR = "As palavras-passe não são iguais.";
Blockly.Msg.MESSAGE_PROGRAM_DELETED = "O programa »$« foi apagado";
Blockly.Msg.MESSAGE_RELATION_DELETED = "A relação do Programa »$« foi apagada";
...
Blockly.Msg.MESSAGE_ROBOT_FIRMWARE_UPDATE = "A versão do firmware do robô é »$«";
...
Blockly.Msg.MESSAGE_USER_NEW = "Olá »$«";
...
Blockly.Msg.NAO_BLINK_TOOLTIP = "The robot blinks once.";  // untranslated
...
Blockly.Msg.NAO_JOINT_LANKLEPITCH = "left ankle pitch";  // untranslated
Blockly.Msg.NAO_JOINT_LANKLEROLL = "right ankle roll";  // untranslated
Blockly.Msg.NAO_JOINT_LELBOWROLL = "left elbow roll";  // untranslated
Blockly.Msg.NAO_JOINT_LELBOWYAW = "left elbow yaw";  // untranslated
Blockly.Msg.NAO_JOINT_LHAND = "left hand";  // untranslated
Blockly.Msg.NAO_JOINT_LHIPPITCH = "left hip pitch";  // untranslated
Blockly.Msg.NAO_JOINT_LHIPROLL = "left hip roll";  // untranslated
Blockly.Msg.NAO_JOINT_LHIPYAWPITCH = "left hip yaw pitch";  // untranslated
Blockly.Msg.NAO_JOINT_LKNEEPITCH = "left knee pitch";  // untranslated
Blockly.Msg.NAO_JOINT_LSHOULDERPITCH = "left shoulder pitch";  // untranslated
Blockly.Msg.NAO_JOINT_LSHOULDERROLL = "left shoulder roll";  // untranslated
Blockly.Msg.NAO_JOINT_LWRISTYAW = "left wrist yaw";  // untranslated
Blockly.Msg.NAO_JOINT_RANKLEPITCH = "right ankle pitch";  // untranslated
Blockly.Msg.NAO_JOINT_RANKLEROLL = "right ankle roll";  // untranslated
Blockly.Msg.NAO_JOINT_RELBOWROLL = "right elbow roll";  // untranslated
Blockly.Msg.NAO_JOINT_RELBOWYAW = "right elbow yaw";  // untranslated
Blockly.Msg.NAO_JOINT_RHAND = "right hand";  // untranslated
Blockly.Msg.NAO_JOINT_RHIPPITCH = "right hip pitch";  // untranslated
Blockly.Msg.NAO_JOINT_RHIPROLL = "right hip roll";  // untranslated
Blockly.Msg.NAO_JOINT_RHIPYAWPITCH = "right hip yaw pitch";  // untranslated
Blockly.Msg.NAO_JOINT_RKNEEPITCH = "right knee pitch";  // untranslated
Blockly.Msg.NAO_JOINT_RSHOULDERPITCH = "right shoulder pitch";  // untranslated
Blockly.Msg.NAO_JOINT_RSHOULDERROLL = "right shoulder roll";  // untranslated
Blockly.Msg.NAO_JOINT_RWRISTYAW = "right wrist yaw";  // untranslated
...
Blockly.Msg.NAO_LED_LEFTEAR = "left ears";  // untranslated
Blockly.Msg.NAO_LED_LEFTEYE = "left eye";  // untranslated
Blockly.Msg.NAO_LED_LEFTFOOT = "left foot";  // untranslated
Blockly.Msg.NAO_LED_RIGHTEAR = "right ears";  // untranslated
Blockly.Msg.NAO_LED_RIGHTEYE = "right eye";  // untranslated
Blockly.Msg.NAO_LED_RIGHTFOOT = "right foot";  // untranslated
Blockly.Msg.NAO_LED_TOOLTIP = "Set the color and intensity of a single LED or a group.";  // untranslated
...
Blockly.Msg.NAO_PART_LARM = "left arm";  // untranslated
Blockly.Msg.NAO_PART_LEGS = "legs";  // untranslated
Blockly.Msg.NAO_PART_LLEG = "left leg";  // untranslated
Blockly.Msg.NAO_PART_RARM = "right arm";  // untranslated
Blockly.Msg.NAO_PART_RLEG = "right leg";  // untranslated
...
Blockly.Msg.NAO_RECOGNIZEWORD = "recognize word";  // untranslated
Blockly.Msg.NAO_RECOGNIZEWORD_TOOLTIP = "The robot tries to recognize the word.";  // untranslated
...
Blockly.Msg.ORA_PROGRAM_SAVE_ERROR_NOT_SAVED_TO_DB = "Ocorreu um erro ao guardar o programa.";
...
Blockly.Msg.ORA_TOOLBOX_LOAD_ERROR_NOT_FOUND = "Os blocos NEPO seleccionados não foram encontrados na base de dados.";
Blockly.Msg.ORA_TOOLBOX_LOAD_SUCCESS = "Caixa de ferramentas carregada";
...
Blockly.Msg.POPUP_SHARE_READ = "LER";
Blockly.Msg.POPUP_SHARE_WITH = "Partilhar com…";
Blockly.Msg.POPUP_SHARE_WRITE = "ESCREVER";
...
Blockly.Msg.POPUP_STARTUP_NEW = "Novidades?";
Blockly.Msg.POPUP_STARTUP_START = "Escolhe o teu sistema!";
Blockly.Msg.POPUP_STARTUP_TITLE = "Bem-vindo";
...
Blockly.Msg.SENSOR_WAIT_PRESSED = "pressionado";
Blockly.Msg.SENSOR_WAIT_PRESSED_RELEASED = "pressionado ou solto";
...
Blockly.Msg.TAB_SIMULATION = "Simulação";
...
Blockly.Msg.TOOLBOX_GLOBAL_VARIABLE = "Variáveis Globais";
...
Blockly.Msg.TOOLBOX_LOOP_VARIABLE = "Variáveis de Ciclo";
...
Blockly.Msg.VARIABLES_CREATE_TITLE = "Criar";
Blockly.Msg.VARIABLES_CREATE_WITH = "com";
